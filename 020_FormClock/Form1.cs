...
namespace _020_FormClock
{
    public partial class Form1 : Form
    {
        //필드를 만든다
        private Graphics g;
        private bool aClockFlag = true; // 아날로그 시계로 시작
        private Point center;           //중심점    
        private int radius;             //반지름
        private int hourHand;           //시침 분침 초침의 길이
        private int minHand;
        private int secHand;
        ...
        {
            Pen p = new Pen(Color.LightBlue, 40);
            ...
            for(int i = 0; i < 360; i+=30)
            {
                ...
                g.FillEllipse(Brushes.Blue, x, y, dotSize, dotSize);
            }
        }
    }
}
